                ...
                for (;;) {
                    ...
                    switch (op) {
                        ...
                        case 11 /* JFALSE */:
                            ...
                            else if (b !== Funbase.BoolValue.True) {
                                // Error: Not a boolean.
    ...
    (function (JsRuntime) {
        ...
        (function (Name) {
            ...
            function setGlodef(tag, val) {
                //n.level = stage;
                if (stage == 2) {
                    JsRuntime.Interop.remove(tag.name);
                }
...
function geomEval(text, compiler) {
    clearOutput();
    GeomJS.Funbase.Name.reset();
    return app.eval_loop(GeomJS.Funbase.Scanner.Reader.fromString(text), insertStr("echo"), insertStr("result"), function (m) { return console.log(m); }, insertStr("error"), compiler);
}
function insertStr(cl) {
    return function (str) {
        var div = document.getElementById("output");
...
function loadCompiler(compiler, toplevel) {
